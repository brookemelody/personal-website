...
function ContactButton({icon, buttonText, link, pathToGIF1, pathToGIF2} : ContactButtonProps) {
    return (
        ...
        <a href={link} target="_blank" rel="noopener noreferrer">
            <button className="rounded-full border-solid border-purple-400 border-4 bg-gradient-to-r from-pink-200 via-purple-200 to-purple-300
             dark:from-bg-pink-300 hover:from-pink-300 hover:to-purple-400 font-bold py-5 px-40 transition-all duration-150">
                <div className="flex gap-2 text-lg tracking-widest text-purple-600">
                {icon}
                {buttonText}
                </div>
            </button>
...
export default function Contact() {
    return (
        ...
        <Wrapper>
            ...
            <h1 className="md:text-2xl"><b>CONTACT</b></h1>
            ...
            width={200}
            height={200}
            className="rounded-full shadow-xl shadow-pink-200 dark:shadow-pink-500"/>
            <p className="mt-5 font-bold text-pink-500 dark:text-pink-300 text-center">I do not have accounts on social media websites (i.e. Instagram, TikTok). Only profiles that are linked below on this page are ones where I have an active public presence online.</p>
