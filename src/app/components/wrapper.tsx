    ...
    return (
        <>
            <div className="flex items-center justify-center">
                ...
                sm -> small screens
                */}
                <div id="container" className="overflow-auto animate-loadContent md:w-3/5 sm:w-5/6 shadow-xl shadow-blue-300 dark:shadow-sky-900 rounded-lg md:px-20 md:py-10 sm:px-5 sm:py-3 mb-10 flex flex-col items-center bg-white dark:bg-gray-600">
                {children}
                </div>
            </div>
        </>
